...
impl PipelineCache {
    ...
    pub fn get_or_compile_pipeline(&self, shader_type: &ShaderType) -> Result<Arc<ComputePipeline>, ComputeError> {
        ...
        // Update compilation statistics
        {
            ...
            stats.average_compilation_time_ns = stats.compilation_time_ns / stats.total_compilations;
        }
    ...
    pub fn get_or_create_bind_group_layout(&self, shader_type: &ShaderType) -> Result<Arc<BindGroupLayout>, ComputeError> {
        // Update cache statistics
        {
            let mut stats = self.cache_stats.write().unwrap();
